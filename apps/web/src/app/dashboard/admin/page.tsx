      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 rounded-full bg-primary/15 text-primary border border-primary/30 text-xs font-bold font-mono">
              ADMIN PORTAL
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="p-5 rounded-2xl border border-border/60 bg-card/70 backdrop-blur-md space-y-3">
            ...
            >
              <span>Manage Platform Voices ({data?.system.activeVoicesCount} Active) →</span>
            </Link>
          </div>
        </div>
        ...
        <div className="lg:col-span-8 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/dashboard/admin/generations" className="text-xs text-primary hover:underline">
